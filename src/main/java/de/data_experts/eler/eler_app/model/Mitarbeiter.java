...
public class Mitarbeiter {
    ...
    public Mitarbeiter(String vorname, String nachname, String kuerzel, boolean isHomie) {
        this(vorname, nachname, kuerzel, isHomie, true);
    }

    public Mitarbeiter(String vorname, String nachname, String kuerzel, boolean isHomie, boolean aktiv) {
        this.vorname = vorname;
        this.nachname = nachname;
        this.kuerzel = kuerzel;
        this.isHomie = isHomie;
        this.aktiv = aktiv;
    }
    ...
    public void setIsHomie(boolean homie) {
        isHomie = homie;
    }

...
public class MitarbeiterView extends VerticalLayout {
    ...
    public MitarbeiterView(MitarbeiterRepository repo) {
        ...
        grid.addColumn(TemplateRenderer
                        ...
                        .withProperty("id", mitarbeiter -> "isAktiv" + mitarbeiter.getId())
...
//        grid.addColumn(TemplateRenderer
//                .<Mitarbeiter>of(
//                        "<input type='checkbox' name='[[item.id]]' value='[[item.id]]' disabled='true' checked='[[item.checked]]'/>")
//                .withProperty("id",  mitarbeiter -> "isHomie" + mitarbeiter.getId())
//                .withProperty("checked", mitarbeiter -> mitarbeiter.isHomie() ? "checked" : "")
//        ).setHeader("Home-Office");
        grid.addColumn(mitarbeiter -> mitarbeiter.isHomie() ? "Homie" : "Officer").setHeader("Home-Office");
